        ...
        <div class="bg-[rgba(0,0,0,0.3)] backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl overflow-hidden p-5 sm:p-8 lg:p-10 relative w-full">
            ...
            <div id="success-state" class="hidden">
                <div class="mb-6 sm:mb-8 text-center">
                    ...
                    <h2 class="text-2xl sm:text-3xl font-bold text-[#cd217d] mb-2">Registration Complete!</h2>
                ...
                <a href="<?= URLROOT ?>/safezone"
                    class="w-full min-h-[52px] bg-[#cd217d] hover:bg-[#a51a64] active:bg-[#8b1550] text-white font-bold py-4 px-4 rounded-xl shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 mt-4 no-underline touch-manipulation text-base">
                    Go to Login
            ...
            <div id="form-state">
                <div class="mb-6 sm:mb-8 relative z-10">
                    <h2 class="text-2xl sm:text-3xl font-bold text-white mb-2 tracking-tight">Set Your Master PIN</h2>
                ...
                <div class="bg-white/10 border border-white/20 rounded-xl p-4 mb-6 text-center">
                    ...
                    <p class="text-lg sm:text-xl font-bold text-white font-mono break-all"><?= htmlspecialchars($data['pernum'] ?? '') ?></p>
                </div>
                ...
                <form id="setpin-form" class="space-y-4 relative z-10">
                    ...
                    <div>
                        ...
                        <input type="password" id="pin" name="pin" required maxlength="6" pattern="[0-9]{6}" inputmode="numeric"
                            class="w-full min-h-[52px] bg-white/10 border border-pink-300/30 rounded-xl py-3.5 px-4 text-white placeholder-pink-200 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent transition-all duration-200 focus:bg-white/20 text-center text-xl font-mono tracking-[0.3em] sm:tracking-[0.5em]"
