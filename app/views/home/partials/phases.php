        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group relative p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-[#cd217d]/50 hover:bg-white/10 transition-all duration-500 hover:-translate-y-2">
                    ...
                    <div class="mb-4 inline-flex items-center px-3 py-1 rounded-full border border-[#cd217d]/30 bg-[#cd217d]/10 text-[#cd217d] text-xs font-bold uppercase tracking-wider shadow-sm">
