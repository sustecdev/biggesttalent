...
<section
    ...
    <div class="max-w-5xl mx-auto w-full relative z-10">
        <!-- Glass Card -->
        <div
            class="hero-content-card relative rounded-3xl p-8 md:p-12 lg:p-16 text-center bg-[rgba(10,10,10,0.6)] backdrop-blur-xl border border-white/10 shadow-2xl">
            <!-- Tagline -->
            <p class="text-sm sm:text-base uppercase tracking-[0.3em] text-[#d5c39e]/90 mb-6 font-medium">Africa's
                Premier Talent Competition</p>
            ...
            <p class="text-base sm:text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto mb-8 leading-relaxed font-light">
                Showcaseee your extraordinary talent on Africa's biggest stage. Compete for fame, fortune, and national
                recognition.
            </p>
            ...
            <?php if (!empty($data['activeSeason'])): ?>
                <div
                    class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#cd217d]/15 border border-[#cd217d]/40 text-[#cd217d] font-bold text-sm uppercase tracking-wider mb-8">
                    <?= htmlspecialchars($data['activeSeason']['title'] ?? 'Active Season') ?>
                    (<?= date('Y', strtotime($data['activeSeason']['start_date'] ?? 'now')) ?>)
                </div>
            <?php endif; ?>

            <!-- Divider -->
            <div class="w-24 h-0.5 bg-gradient-to-r from-transparent via-[#cd217d]/60 to-transparent mx-auto mb-8">
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center items-center flex-wrap">
                ...
                <?php else: ?>
                    <a href="javascript:void(0)" onclick="showFeatureClosedModal('Nominations')"
                        class="hero-cta-primary w-full sm:w-auto nominate-trigger service-locked">
                        Nominate Now
                    </a>
                <?php endif; ?>
        ...
        <div class="relative w-full mt-10 rounded-2xl overflow-hidden shadow-2xl border border-white/10 group">
            <div
                class="absolute inset-0 bg-gradient-to-t from-[#0a0a0a] via-transparent to-transparent z-10 opacity-70 pointer-events-none">
            </div>
            ...
            <button id="volumeBtn" onclick="toggleVolume()"
                class="absolute bottom-4 right-4 bg-black/50 hover:bg-black/70 text-white p-2 rounded-full backdrop-blur-sm transition-all z-20">
                <svg id="muteIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M11 5L6 9H2v6h4l5 4V5z"></path>
                    <line x1="23" y1="9" x2="17" y2="15"></line>
                    <line x1="17" y1="9" x2="23" y2="15"></line>
                </svg>
                <svg id="unmuteIcon" class="hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <!-- Scroll Indicator -->
        <a href="#phases"
            class="hero-scroll-indicator flex flex-col items-center gap-2 mt-8 text-gray-500 hover:text-[#cd217d] transition-colors">
