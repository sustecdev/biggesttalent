...
<section class="py-20 md:py-32 relative overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-t from-[#cd217d]/10 to-transparent pointer-events-none z-[1]"></div>
    <div
        class="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#aa843f] opacity-10 blur-[120px] rounded-full pointer-events-none z-[1]">
    </div>

    <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <h2 class="text-4xl sm:text-7xl font-black text-white mb-8 tracking-tighter home-section-heading">
            READY TO <br>
